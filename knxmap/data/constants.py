...
KNX_BUS_MEDIUMS = {0: "TP1", 1: "PL110", 2: "RF", 5: "KNXnet/IP"}
...
TPCI_UNNUMBERED_CONTROL_DATA_TYPES = {"CONNECT": 0x00, "DISCONNECT": 0x01}

TPCI_NUMBERED_CONTROL_DATA_TYPES = {"ACK": 0x02, "NACK": 0x03}
...
CEMI_PRIORITIES = {0x00: "system", 0x01: "normal", 0x02: "urgent", 0x03: "low"}
...
CEMI_TPCI_TYPES = {"UDP": 0x00, "NDP": 0x01, "UCD": 0x02, "NCD": 0x03}

_CEMI_TPCI_TYPES = {0x00: "UDP", 0x01: "NDP", 0x02: "UCD", 0x03: "NCD"}
...
OBJECTS = {
    ...
    1: {"PID_EXT_FRAMEFORMAT": 51, "PID_ADDRTAB1": 52, "PID_GROUP_RESPONSER_TABLE": 53},
    2: {"PID_TABLE": 52},
    ...
    7: {"PID_LTE_ROUTESELECT": 51, "PID_LTE_ROUTETABLE": 52},
    8: {
    ...
    9: {"PID_GRPOBJTABLE": 51, "PID_EXT_GRPOBJREFERENCE": 52},
    10: {"PID_POLLING_STATE": 51, "PID_POLLING_SLAVE_ADDR": 52, "PID_POLL_CYCLE": 53},
    11: {
...
for k, v in OBJECTS.items():
    OBJECTS[k] = collections.OrderedDict(sorted(v.items(), key=lambda v: v[1]))
